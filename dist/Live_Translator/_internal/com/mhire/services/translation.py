...
class Translation:
    def __init__(self, config: Config):
        ...
        self.translation_prompts = {
            ("ar", "en"): "You are a direct Arabic to English translator. Output ONLY the translated text, nothing else. DON'T INCLUDE any explanations, questions, or other text. Translate while preserving cultural context:",
            ("ar", "de"): "You are a direct Arabic to German translator. Output ONLY the translated text, nothing else. DON'T INCLUDE any explanations, questions, or other text. Translate while preserving cultural context:",
            ("en", "ar"): "You are a direct English to Arabic translator. Output ONLY the translated text, nothing else. DON'T INCLUDE any explanations, questions, or other text. Translate while preserving proper Arabic grammar:",
            ("en", "de"): "You are a direct English to German translator. Output ONLY the translated text, nothing else. DON'T INCLUDE any explanations, questions, or other text:",
            ("de", "ar"): "You are a direct German to Arabic translator. Output ONLY the translated text, nothing else. DON'T INCLUDE any explanations, questions, or other text. Translate while preserving proper Arabic grammar:",
            ("de", "en"): "You are a direct German to English translator. Output ONLY the translated text, nothing else. DON'T INCLUDE any explanations, questions, or other text:"
        }
